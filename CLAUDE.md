...
All joints are revolute, ±90° range (±1.5708 rad). Gripper joints range -0.7 to 0 rad. The gripper uses a mimic joint (gripper_joint_2 mirrors gripper_joint_1). A fixed `world` frame is offset -90° from `base_link`.
